...
class ForecastPoint:
    def __init__(self, location_name, spot_id):
        """
        A spot forecast point object

        Parameters
        ----------
        location_name: str
            an arbitrary location name used to identify this forecast point
        spot_id: int
            a list of spot IDs for this point
        """
    ...
    def load_point(self, parameters_to_load, date_range):
        ...
        self.input_layer.append(
            NetCDF.open_from_forecast_point(
